...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:serverpod_todo_server/src/generated/greetings/greeting.dart'
    as _i5;
import 'package:serverpod_todo_server/src/generated/todos/todo.dart' as _i6;
import 'package:serverpod_todo_server/src/generated/todos/priority.dart' as _i7;
import 'package:serverpod_todo_server/src/generated/protocol.dart';
import 'package:serverpod_todo_server/src/generated/endpoints.dart';
  ...
  _i3.Future<List<_i6.Todo>> getByPriorities(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'todo',
            method: 'getByPriorities',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'todo',
          methodName: 'getByPriorities',
          parameters: _i1.testObjectToJson({'priorities': priorities}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<_i6.Todo> updateOrAddIfNotExist(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'todo',
            method: 'updateOrAddIfNotExist',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'todo',
          methodName: 'updateOrAddIfNotExist',
          parameters: _i1.testObjectToJson({'todo': todo}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
